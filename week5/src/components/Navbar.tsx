        ...
        <nav className="w-full bg-gray-900 text-white px-6 py-3 flex items-center justify-between shadow-md">
            ...
            <div className="flex items-center gap-6 text-sm font-medium">
                ...
                {accessToken ? (
                    <>
                        {name && (
                            <span className="text-gray-300 text-sm">{name}님 ㅎㅇㅇ!</span>
                        )}
                        <Link to="/my" className="hover:text-purple-400 transition-colors">
                            마이페이지
                        </Link>
                        <button
                            onClick={logout}
                            className="bg-purple-600 hover:bg-purple-700 px-4 py-1 rounded-full transition-colors"
                        >
                            로그아웃
                        </button>
                    </>
